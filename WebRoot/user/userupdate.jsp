...
<span style="color:#ffffff;font-size: 18px;font-weight: bold;" >用户修改</span>
</div></div>
<br/>
<br/>
<br/>
<div style="margin-left:-10px">
<form action="userupdate2" method="post" accept-charset="utf-8" >
<table width="1150" height="120" border="1">
   <tr>
    <td width="212" background="img/bg7.jpg"><div align="right" class="STYLE1">真实姓名</div></td>
    <td width="913">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" name="xingming" size="30" value="${bean.xingming }"/><input type="hidden" name="id" value="${bean.id }"/>
    </td>
  </tr>
  <tr>
