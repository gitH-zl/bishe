...
function show(id){
		window.showModalDialog("bookshow?id="+id, null, 
...
<br/>
<br/>
<a href="bookadd.jsp"><img src="img/xinzeng.jpg" width="56" height="27" border="0"/></a>
<a href="####" onclick="delbook()"><img src="img/shanchu.jpg" width="56" height="27" border="0"/></a>
<a href="####" onclick="javascript:history.go(-1);"><img src="img/fanhui.jpg" width="56" height="27" border="0"/></a>
<div id="Layer2">

<form action="booksearch" method="post" accept-charset="utf-8">
<div style="padding-top: 5px;padding-left: 20px;">
						...
						<table cellpadding="5" cellspacing="0" style="width: 100%;border-collapse:collapse;
							...
							<c:forEach items="${list}" var="bean" varStatus="row">
								<tr onmouseover="this.style.backgroundColor='#e0ffff';"
									...
									<td align="center">
									   <a href="bookshow?id=${bean.id }"  target="_blank">查看图书详情</a>&nbsp;&nbsp;&nbsp;&nbsp; 
									   <a href="bookupdate?id=${bean.id }">修改</a>
									</td>
