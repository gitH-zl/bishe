...
<div class="STYLE1" id="Layer2">
 ...
 <div id="Layer3">
  ...
  <%
  if("图书管理".equals(title)){
	  out.println("<a href='book/booklist' target='mainFrame'>图书管理</a>");
	  out.println("<br/><br/>");
  }else if("用户信息管理".equals(title)){
 
	  out.println("<a href='user/userlist' target='mainFrame'>用户信息列表</a>");  
	  out.println("<br/><br/>");
