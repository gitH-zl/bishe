...
document.getElementById("top5").src='img/52.jpg';
...
图书在线阅读下载系统
  ...
  <div id="Layer2">
  	<a href="index1" target="_top" onclick="changeimg(1)"><img id="top1" src="img/11.jpg" width="113" height="20" border="0"/></a>&nbsp;&nbsp;
  	<a href="left1.jsp?title=1" target="leftFrame" onclick="changeimg(5)"><img id="top5" src="img/52.jpg" width="113" height="20" border="0"/></a>&nbsp;&nbsp;
  
 	<a href="left1.jsp?title=3" target="leftFrame" onclick="changeimg(4)"><img id="top4" src="img/42.jpg" width="113" height="20" border="0"/></a>&nbsp;&nbsp;  
